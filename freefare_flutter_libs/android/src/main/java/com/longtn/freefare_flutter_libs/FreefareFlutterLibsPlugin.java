package com.longtn.freefare_flutter_libs;
...
/** FreefareFlutterLibsPlugin */
public class FreefareFlutterLibsPlugin implements FlutterPlugin {

  private static final String CHANNEL = "freefare_flutter_libs";
